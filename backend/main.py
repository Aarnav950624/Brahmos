...
from app.api.v1 import ai, wallet, asha, doctor, pharmacy, lab, citizen, scheme, caremap, emergency, nudge, panchayat, visit_brief, asha_sync, caregiver
...
app.include_router(nudge.router, prefix="/api/v1/notifications", tags=["Nudge Engine"])
app.include_router(panchayat.router, prefix="/api/v1/panchayat", tags=["Panchayat"])
