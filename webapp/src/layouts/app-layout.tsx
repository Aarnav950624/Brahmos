...
export function AppLayout() {
  return (
    <ShellProvider>
      <CareGraphSync />
      <div className="flex h-dvh max-h-dvh overflow-x-visible overflow-y-hidden bg-background">
        <Sidebar />
        <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          <Navbar />
          <main className="min-h-0 flex-1 overflow-y-auto px-4 py-4 md:px-7 md:py-6">
            <PageTransition>
              <Outlet />
            </PageTransition>
          </main>
