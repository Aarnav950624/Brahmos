...
export const escalationRepository = {
  ...
  getRiskData(userId: string, patientId: string): PatientRiskData {
    ...
    let explanation = `${card.full_name.split(" ")[0]} is under post-discharge monitoring for ${card.primary_diagnosis}. Live risk score ${live.score}/100 (${live.level}).`;
