...
import { AHMEDABAD_CARE_SITES, rankCareSites } from "@/data/ahmedabad-care-sites";
...
export function CaregiverHospitalsPage() {
  ...
  const hospitals = rankCareSites(AHMEDABAD_CARE_SITES, null, "all").slice(
    0,
    10,
  );
