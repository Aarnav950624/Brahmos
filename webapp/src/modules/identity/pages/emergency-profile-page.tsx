        ...
        <div className="overflow-hidden rounded-[1.75rem] border border-red-200 bg-card shadow-soft dark:border-red-900">
          ...
          <div className="space-y-4 p-5">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              Limited public view from the patient QR — blood group, allergies,
              current medicines, and contacts only. Recovery scores and full
              history are not included. {p.disclaimer}
            </p>
          </div>
        </div>
      </motion.div>
