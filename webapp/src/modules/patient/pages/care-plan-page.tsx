    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-5 pb-10">
      ...
      >
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Organized from your doctor&apos;s approved discharge summary. Meals,
          activity, and check-ins live here — log each medicine dose on{" "}
          <Link to="/patient/medicines" className="font-medium text-primary underline-offset-2 hover:underline">
            Medicines
          </Link>
          .
        </p>
